...
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {المطور} فقط  \n💥" end
local NumMnsha = redis:scard(CZAR..':Hussain:'..msg.chat_id_)
if NumMnsha ==0 then 
return "♦️│عذرا لا يوجد منشى اساسي \n!" 
end
redis:del(CZAR..':Hussain:'..msg.chat_id_)
...
sendMsg(msg.chat_id_,msg.id_,'📛*│* عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس كزار يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n💥')
end  
else
...
send_key(msg.sender_user_id_,'  [⚜│قناة سورس : مـاكـس](t.me/@TH1CZAR)',nil,inline,msg.id_)
return false
end
...
redis:set(CZAR..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل الترحيب' then
if redis:get(CZAR..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل الترحيب سابقا')
redis:set(CZAR..'welc'..msg.chat_id_,'off')
redis:del(CZAR..'welc'..msg.chat_id_,'on')
else
...
if msg.text then 
redis:hset(CZAR..'replay:'..msg.chat_id_,klma,Flter_Markdown(msg.text))
...
if msg.text then
redis:hset(CZAR..'replay:all',klma,Flter_Markdown(msg.text))
...
elseif msg.voice then
redis:hset(CZAR..'replay_voice:group:',klma,voice_id)
redis:del(CZAR..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂╿تم اضافه بصمه صوت للرد العام ✓\n🗂╽يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(CZAR..'replay_animation:group:',klma,animation_id)
redis:del(CZAR..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂╿تم اضافه متحركه للرد العام ✓\n🗂╽يمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الصوره الاتيه ')
elseif msg.video then
redis:hset(CZAR..'replay_video:group:',klma,video_id)
redis:del(CZAR..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂╿تم اضافه فيديو للرد العام ✓\n🗂╽يمكنك ارسال ❴ ['..klma..'] ❵لاضهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(CZAR..'replay_audio:group:',klma,audio_id)
redis:del(CZAR..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂╿تم اضافه للصوت للرد العام ✓\n🗂╽يمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(CZAR..'replay_sticker:group:',klma,sticker_id)
redis:del(CZAR..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
GetUserID(msg.sender_user_id_,function(arg,data)  
welcome = (redis:get(CZAR..'welcome:msg'..msg.chat_id_) or "🙋🏻‍♂│اهلن بك عزيزي {الاسم}\n🎟│معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين ♥\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n⚜│اسم الكروب » {المجموعه}")
if welcome then
rules = (redis:get(CZAR..'rulse:msg'..msg.chat_id_) or "👨🏻‍💻╿مرحبأ عزيري القوانين كلاتي 👇🏻\n♦️│ممنوع نشر الروابط\n⚠️│ممنوع التكلم او نشر صور اباحيه\n⚔│ممنوع  اعاده توجيه\n💭│ممنوع التكلم بلطائفه\n♥️╽الرجاء احترام المدراء والادمنيه 😅\n")
...
--------------------------------------------
if msg.adduser and redis:get(CZAR..'welcome:get'..msg.chat_id_) then
...
elseif Text== "عبود" then return sendMsg(msg.chat_id_,msg.id_,"[مالـك السورس 😍](t.me/AA_B1")
elseif Text== "عبدالله" then return sendMsg(msg.chat_id_,msg.id_,"[ مطور سورس كزار 😍](t.me/AA_B1")
...
👨🏽‍⚖️│بالتـوفيـق عزيزي ...
🎁╽[اضغط هنا لديك مفاجئه](https://t.me/TH1CZAR)
]] )
--=====================================
